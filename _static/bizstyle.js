...
$(window).resize(function(){
    if ($(window).width() <= 776) {
        ...
        $("div.related:first ul li:not(.right):first a").text("WiSHFUL Framework 2.0 2.0 documentation");
        $("div.related:last  ul li:not(.right):first a").text("WiSHFUL Framework 2.0 2.0 documentation");
    }
});